...
export default function Dashboard() {
  ...
  return (
    <div className="min-h-screen bg-parchment text-text-primary font-raleway select-none">
      
      {/* Header bar */}
      <header className="bg-card-surface text-text-primary py-4 px-6 md:px-12 flex flex-col md:flex-row justify-between items-center border-b border-primary-accent/20 shadow-md">
        <div className="text-center md:text-left">
          ...
          <p className="text-xs text-primary-accent font-raleway tracking-widest uppercase mt-0.5">
            Nikah &amp; Walimah Host Portal
          </p>
        </div>
        <div className="mt-2 md:mt-0 text-center md:text-right border border-primary-accent/30 px-3 py-1 rounded bg-parchment/50">
          <span className="font-amiri text-primary-accent text-sm font-semibold">{settings.nikahDate}</span>
        </div>
      </header>
      ...
      <main className="max-w-7xl mx-auto p-4 md:p-8">
        ...
        {/* Navigation Tabs */}
        <div className="flex flex-wrap border-b border-primary-accent/30 mb-8 gap-2">
          {[
            ...
            return (
              <button
                ...
                className={`flex items-center space-x-2 px-5 py-3 text-xs md:text-sm font-bold uppercase tracking-wider border-b-2 transition-colors active:scale-95 ${active ? 'border-primary-accent text-primary-accent bg-card-surface/20' : 'border-transparent text-primary-accent hover:text-primary-accent hover:bg-card-surface/10'}`}
              >
        ...
        {/* Tab Content Panels */}
        <div className="bg-card-surface rounded-lg border border-primary-accent/20 shadow-sm p-4 md:p-8">
          ...
          {activeTab === 'overview' && (
            <div className="space-y-8 animate-fadeIn">
              ...
              <div className="grid grid-cols-2 lg:grid-cols-5 gap-4">
                {[
                  { label: 'Total Invited', value: totalInvited, icon: Users, color: 'text-primary-accent', bg: 'bg-primary-accent/5' },
                  ...
                  { label: 'Total Guest Count', value: totalGuestCount, icon: UserCheck, color: 'text-primary-accent', bg: 'bg-card-surface/20' }
                ].map(stat => {
                  const Icon = stat.icon;
                  return (
                    <div key={stat.label} className={`${stat.bg} p-5 rounded-lg border border-primary-accent/10 flex flex-col justify-between`}>
                      <div className="flex justify-between items-start mb-2">
                        <span className="text-[10px] font-bold text-primary-accent uppercase tracking-widest">{stat.label}</span>
              ...
              <div className="border border-primary-accent/15 rounded-lg p-5 bg-parchment/50">
                <div className="flex justify-between items-center mb-3">
                  <h3 className="text-xs font-bold text-primary-accent uppercase tracking-widest">RSVP Response Rate</h3>
                ...
                <div className="flex gap-4 mt-3 text-[10px] font-bold text-primary-accent uppercase tracking-wider">
              ...
              <div className="space-y-4">
                <h3 className="text-xs font-bold text-primary-accent uppercase tracking-widest">Recent Responses</h3>
                <div className="border border-primary-accent/20 rounded-lg overflow-hidden bg-card-surface shadow-sm">
                  {recentResponses.length > 0 ? (
                    <div className="divide-y divide-gray-100">
                      {recentResponses.map(inv => (
                        <div key={inv.id} className="flex justify-between items-center p-4 hover:bg-parchment/30 transition-colors">
                          <div>
                            <p className="font-semibold text-sm text-text-primary">{inv.name}</p>
              ...
              <div className="flex flex-col md:flex-row gap-4 justify-between items-center">
                ...
                <div className="relative w-full md:w-96">
                  ...
                  <input
                    ...
                    className="pl-10 pr-4 py-2 w-full border border-primary-accent/30 rounded-lg focus:outline-none focus:border-primary-accent bg-parchment/20 text-sm"
                  />
                </div>
                  ...
                  {[
                    ...
                    return (
                      <button
                        ...
                        className={`px-3 py-1.5 rounded-full text-xs font-semibold tracking-wider transition-all uppercase ${active ? 'bg-primary-accent text-text-primary' : 'bg-card-surface/30 text-primary-accent hover:bg-card-surface/60'}`}
                      >
                        {pill.label}
                      </button>
                    );
              ...
              <div className="border border-primary-accent/20 rounded-lg overflow-hidden bg-card-surface shadow-sm">
                <div className="overflow-x-auto">
                  <table className="w-full text-left text-xs border-collapse">
                    <thead>
                      <tr className="bg-parchment border-b border-primary-accent/20 text-primary-accent uppercase font-bold tracking-wider">
                        ...
                        filteredInvitees.map(inv => {
                          ...
                          return (
                            <tr key={inv.id} className="hover:bg-parchment/20 transition-colors">
                              ...
                              <td className="p-4 font-mono text-[10px] text-gray-500 whitespace-nowrap">
                                <div className="flex items-center space-x-1.5">
                                  ...
                                  <button
                                    ...
                                    className="p-1 hover:text-primary-accent rounded hover:bg-card-surface/30"
                                    title="Copy Link"
                                  >
                              ...
                              <td className="p-4 text-center font-bold text-primary-accent">
                              ...
                              <td className="p-4">
                                <div className="flex items-center justify-center space-x-2">
                                  ...
                                  <Link
                                    to={`/invite/${inv.slug}`}
                                    target="_blank"
                                    className="p-1.5 bg-card-surface text-primary-accent rounded hover:bg-primary-accent/80 hover:text-text-primary transition-colors"
                ...
                <div className="bg-parchment/40 p-4 border-t border-primary-accent/10 flex justify-between items-center text-xs text-primary-accent font-bold">
          ...
          {activeTab === 'add-import' && (
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 animate-fadeIn">
              ...
              <div className="border border-primary-accent/20 rounded-lg p-6 bg-card-surface space-y-6">
                <div>
                  <h3 className="text-sm font-bold text-primary-accent uppercase tracking-widest">Add Single Invitee</h3>
                  <p className="text-xs text-gray-400 mt-1">Create a customized web invitation link for a single guest.</p>
                </div>

                <div className="space-y-4">
                  <div>
                    <label className="block text-xs font-bold uppercase tracking-wider text-primary-accent mb-1">
                      Guest Name (Required)
                    </label>
                    <input
                      type="text"
                      ...
                      className="w-full px-3 py-2 border border-primary-accent/30 rounded-lg focus:outline-none focus:border-primary-accent bg-parchment/20 text-sm"
                    />
                  </div>
                  ...
                  <button
                    ...
                    className="w-full bg-primary-accent hover:bg-primary-accent/80 disabled:bg-gray-200 text-text-primary font-semibold text-xs uppercase tracking-widest py-3 rounded-lg transition-colors active:scale-[0.98]"
                  >
                  ...
                  {singleSuccessLink && (
                    <div className="bg-green-50 border border-green-200 rounded-lg p-4 space-y-2 mt-4">
                      ...
                      <div className="flex items-center space-x-2 bg-card-surface border border-green-200 p-2 rounded text-xs font-mono overflow-x-auto">
                        ...
                        <button
                          ...
                          className="text-primary-accent hover:underline whitespace-nowrap font-bold"
                        >
                          Copy
                        </button>
                      </div>
              ...
              <div className="border border-primary-accent/20 rounded-lg p-6 bg-card-surface space-y-6">
                <div>
                  <h3 className="text-sm font-bold text-primary-accent uppercase tracking-widest">CSV Bulk Import</h3>
                ...
                <div className="space-y-4">
                  ...
                  {/* File Upload Box */}
                  <div className="border-2 border-dashed border-primary-accent/40 rounded-lg p-6 flex flex-col items-center justify-center text-center cursor-pointer hover:bg-parchment/30 transition-colors relative">
                    <input
                      type="file"
                      accept=".csv"
                      onChange={(e) => {
                    ...
                    />
                    <FileSpreadsheet className="w-10 h-10 text-primary-accent mb-2" />
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      className="w-full px-3 py-2 border border-primary-accent/30 rounded-lg focus:outline-none focus:border-primary-accent bg-parchment/20 font-mono text-xs"
                    />
                  </div>
                  ...
                  <button
                    ...
                    className="w-full bg-primary-accent hover:bg-primary-accent/80 text-text-primary font-semibold text-xs uppercase tracking-widest py-3 rounded-lg transition-colors active:scale-[0.98]"
                  >
                  ...
                  {importProgress && (
                    <div className="bg-card-surface/30 border border-primary-accent/30 rounded-lg p-4 space-y-2">
                      <div className="flex justify-between items-center text-xs">
                        <span className="font-bold text-primary-accent">{importProgress.status}</span>
                        <span className="text-primary-accent">{importProgress.current} / {importProgress.total} processed</span>
                      </div>
                  ...
                  <div className="border border-gray-100 rounded bg-gray-50 p-3">
                    <p className="text-[10px] font-bold text-primary-accent uppercase tracking-widest mb-1.5 flex items-center">
                      <HelpCircle className="w-3.5 h-3.5 text-gray-400 mr-1" />
                      Sample CSV File Format
                    </p>
                    <pre className="text-[9px] font-mono bg-card-surface text-green-400 p-2 rounded overflow-x-auto">
{`name,phone
Bilal Ahmed,+919876543210
...
Dr. Salman & Family,`}
          ...
          {activeTab === 'settings' && (
            <div className="space-y-6 animate-fadeIn">
              <div>
                <h3 className="text-sm font-bold text-primary-accent uppercase tracking-widest">Wedding Event Settings</h3>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="border border-gray-100 p-4 rounded-lg bg-gray-50/50 space-y-4">
                  <h4 className="text-xs font-bold text-primary-accent uppercase tracking-widest border-b border-gray-200 pb-1.5">Honoree Details</h4>
                  
                  <div className="grid grid-cols-2 gap-4">
                    <div>
                      <label className="block text-[10px] font-bold uppercase tracking-wider text-primary-accent mb-1">Groom Name</label>
                      <input
                        type="text"
                        value={settingsForm.groomName}
                        onChange={(e) => setSettingsForm({ ...settingsForm, groomName: e.target.value })}
                        className="w-full px-3 py-2 border border-gray-200 rounded bg-card-surface text-xs focus:outline-none focus:border-primary-accent"
                      />
                    </div>
                    <div>
                      <label className="block text-[10px] font-bold uppercase tracking-wider text-primary-accent mb-1">Bride Name</label>
                      <input
                        type="text"
                  ...
                  <div>
                    <label className="block text-[10px] font-bold uppercase tracking-wider text-primary-accent mb-1">Groom Parents</label>
                    <input
                      type="text"
                  ...
                  <div>
                    <label className="block text-[10px] font-bold uppercase tracking-wider text-primary-accent mb-1">Bride Parents</label>
                    <input
                      type="text"
                ...
                {/* Countdown target */}
                <div className="border border-gray-100 p-4 rounded-lg bg-gray-50/50 space-y-4">
                  <h4 className="text-xs font-bold text-primary-accent uppercase tracking-widest border-b border-gray-200 pb-1.5">Countdown Target Event</h4>
                  <div>
                    <label className="block text-[10px] font-bold uppercase tracking-wider text-primary-accent mb-1">Target Date &amp; Time (ISO Format)</label>
                    <input
                      type="datetime-local"
                ...
                <div className="border border-gray-100 p-4 rounded-lg bg-gray-50/50 space-y-4">
                  <h4 className="text-xs font-bold text-primary-accent uppercase tracking-widest border-b border-gray-200 pb-1.5 font-semibold">Event 1: Nikah Ceremony</h4>
                  
                  <div className="grid grid-cols-2 gap-4">
                    <div>
                      <label className="block text-[10px] font-bold uppercase tracking-wider text-primary-accent mb-1">Date</label>
                      <input
                        type="text"
                    ...
                    <div>
                      <label className="block text-[10px] font-bold uppercase tracking-wider text-primary-accent mb-1">Time</label>
                      <input
                        type="text"
                  ...
                  <div>
                    <label className="block text-[10px] font-bold uppercase tracking-wider text-primary-accent mb-1">Venue Name</label>
                    <input
                      type="text"
                  ...
                  <div>
                    <label className="block text-[10px] font-bold uppercase tracking-wider text-primary-accent mb-1">Address Details</label>
                    <input
                      type="text"
                  ...
                  <div>
                    <label className="block text-[10px] font-bold uppercase tracking-wider text-primary-accent mb-1">Google Maps URL Link</label>
                    <input
                      type="text"
                ...
                <div className="border border-gray-100 p-4 rounded-lg bg-gray-50/50 space-y-4">
                  <h4 className="text-xs font-bold text-primary-accent uppercase tracking-widest border-b border-gray-200 pb-1.5 font-semibold">Event 2: Walimah Reception</h4>
                ...
                <div className="border border-gray-100 p-4 rounded-lg bg-gray-50/50 space-y-4 md:col-span-2">
                  <h4 className="text-xs font-bold text-primary-accent uppercase tracking-widest border-b border-gray-200 pb-1.5">WhatsApp Sharing Message Template</h4>
                  
                  <div>
                    <label className="block text-[10px] font-bold uppercase tracking-wider text-primary-accent mb-1">Template Text</label>
                    <textarea
                      rows="4"
                      value={settingsForm.whatsappTemplate}
                      onChange={(e) => setSettingsForm({ ...settingsForm, whatsappTemplate: e.target.value })}
                      className="w-full px-3 py-2 border border-gray-200 rounded bg-card-surface text-xs focus:outline-none focus:border-primary-accent font-mono leading-relaxed"
                    />
                    
                    {/* Template keys info */}
                    <div className="bg-card-surface/20 p-3 rounded border border-primary-accent/20 text-[10px] text-primary-accent mt-2 space-y-1">
                      <p className="font-bold text-primary-accent">Supported dynamic replacement keywords:</p>
              ...
              <div className="pt-4 flex justify-end">
                <button
                  ...
                  className="bg-primary-accent hover:bg-primary-accent/80 text-text-primary font-semibold text-xs uppercase tracking-widest px-8 py-3 rounded-lg transition-colors active:scale-[0.98] flex items-center space-x-2"
                >
